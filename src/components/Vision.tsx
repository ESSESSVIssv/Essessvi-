        ...
        <div className="w-full">
          <div>
            ...
            <div className="space-y-2 text-base md:text-lg text-text-main/60 font-normal leading-relaxed">
              ...
              <p className="text-text-main/80 font-mono text-xs uppercase tracking-widest border-l-2 border-white/20 pl-4">
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-3 gap-12 border-t border-text-main/10 pt-16">
          {meta.map((stat, idx) => (
            <div key={idx} className="group">
              ...
              <div className="text-4xl md:text-6xl font-display font-bold text-text-main uppercase tabular-nums">
                {stat.value}
              </div>
            </div>
          ))}
