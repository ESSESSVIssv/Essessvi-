      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10 w-full">
        <div className="w-full">
          ...
          >
            ...
            <div className="space-y-2 text-base md:text-lg text-gray-400 font-normal leading-relaxed">
              <p>
              ...
              <p>
                Recently, I built <span className="text-white font-medium">JobLence</span>, an AI-powered job application assistant that analyzes resumes, matches candidates with relevant job opportunities, and streamlines the application process through automation. The project was driven by the challenge of making job discovery and applications more efficient for candidates.
              </p>
              <p>
              ...
              <p className="text-brand font-medium border-l-2 border-brand/50 pl-4 italic">
        ...
        <div className="mt-16 grid grid-cols-2 lg:grid-cols-3 gap-12 border-t border-white/5 pt-16">
          {meta.map((stat, idx) => (
            <div key={idx} className="group">
              <div className="text-brand font-mono text-[10px] uppercase tracking-[0.3em] mb-4 font-light opacity-60 group-hover:opacity-100 transition-opacity">
                {stat.label}
              </div>
              <div className="text-4xl md:text-6xl font-display font-bold text-white uppercase tabular-nums">
                {stat.value}
              </div>
            </div>
          ))}
