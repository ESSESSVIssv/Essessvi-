...
export const PERSONAL_INFO = {
  ...
  firstName: "ESSESSVI",
  role: "Prompt Engineer & Aspiring Product Manager | n8n • OpenAI • Claude | Open to Internships | Passionate about building things that matter | Human first, professional second.",
